...
export const websiteSchema = {
    ...
    potentialAction: {
        '@type': 'SearchAction',
        target: 'https://geekytechh.in/?s={search_term_string}',
    ...
    itemListElement: [
        {
            ...
            position: 1,
            name: 'Home',
            item: 'https://geekytechh.in',
        },
        {
            '@type': 'ListItem',
            position: 2,
            name: 'Services',
            item: 'https://geekytechh.in/#services',
        },
        {
            '@type': 'ListItem',
            position: 3,
            name: 'Projects',
            item: 'https://geekytechh.in/#projects',
        },
        {
            '@type': 'ListItem',
            position: 4,
            name: 'Skills',
            item: 'https://geekytechh.in/#skills',
        },
        {
            '@type': 'ListItem',
            position: 5,
            name: 'Contact',
            item: 'https://geekytechh.in/#contact',
        },
    ],
}
